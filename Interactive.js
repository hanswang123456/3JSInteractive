...
function init() {
  ...
  document.getElementById("sp").innerHTML =
    "<img src = 'https://i.ya-webdesign.com/images/csgo-crosshair-png-1.png' width = 250px; height = 250px;>";
  function make(x, z) {
    ...
    animalH = new THREE.Mesh(
      ...
      new THREE.MeshBasicMaterial(pigHead)
    );
  ...
  for (let x = 0; x < 40; x++) {
    for (let z = 0; z < 40; z++) {
      mesh = new THREE.Mesh(
        ...
        new THREE.MeshBasicMaterial(starterBlock)
      );
